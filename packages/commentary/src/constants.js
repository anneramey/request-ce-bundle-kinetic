...
export const LETTERS_FIELD = 'Letters';
export const ILOI_FIELD = 'ILoI';
export const LOD_FIELD = 'LoD';
export const XLOI_FIELD = 'XLoI';
export const LOAR_FIELD = 'LoAR';
export const PROPOSED_BLAZON_FIELD = 'Proposed Blazon';
export const LOI_JSON_FIELD = 'JSON of Requests';
